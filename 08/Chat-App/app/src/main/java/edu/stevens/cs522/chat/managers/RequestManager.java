...
public class RequestManager extends Manager<ChatMessage> {
    ...
    public void persist(ChatMessage message) {
        ...
        //insert chatroom if not exist
//        ChatRoom chatRoom = new ChatRoom(message.chatRoom);
//        ContentValues chatRoomValues = new ContentValues();
//        chatRoom.writeToProvider(chatRoomValues);
//        Uri chatRoomUri = getSyncResolver().insert(ChatroomContract.CONTENT_URI, chatRoomValues);
//        long chatRoomId = ChatroomContract.getId(peerUri);
