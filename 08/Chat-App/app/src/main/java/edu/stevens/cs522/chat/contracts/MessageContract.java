...
public class MessageContract extends BaseContract {
    ...
    public static final String[] COLUMNS = {ID, SEQUENCE_NUMBER, MESSAGE_TEXT, CHAT_ROOM, CHAT_ROOM_ID, TIMESTAMP, LATITUDE, LONGITUDE, SENDER, SENDER_ID};
    ...
    public static String getMessageText(ContentValues out) {
        return out.getAsString(MESSAGE_TEXT);
    }
...
//        out.put(TIMESTAMP, timestamp);
    ...
    * CHAT_ROOM
    ...
    public static String getChatRoom(ContentValues out) {
        return out.getAsString(CHAT_ROOM);
    }

    /*
    * CHAT_ROOM_ID
     */
    private static int chatRoomIDColumn = -1;
    public static long getChatRoomID(Cursor cursor) {
        if (chatRoomIDColumn < 0) {
            chatRoomIDColumn = cursor.getColumnIndexOrThrow(CHAT_ROOM_ID);
        }
        return cursor.getLong(chatRoomIDColumn);
    }
    public static void putChatRoomID(ContentValues out, long chatRoomID) {
        out.put(CHAT_ROOM_ID, chatRoomID);
    }
